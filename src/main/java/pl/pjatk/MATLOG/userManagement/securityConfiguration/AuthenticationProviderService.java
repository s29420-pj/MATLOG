...
public class AuthenticationProviderService implements AuthenticationProvider {
    ...
    private final MatlogUserDetailsService userDetailsService;
    private final PasswordEncoder passwordEncoder;

    public AuthenticationProviderService(MatlogUserDetailsService userDetailsService, PasswordEncoder passwordEncoder) {
