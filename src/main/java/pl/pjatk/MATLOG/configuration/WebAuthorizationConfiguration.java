        ...
        http
                ...
                .authorizeHttpRequests(
                    auth -> auth
                            ...
                            .requestMatchers("/tutor/user/controller/change/password").hasRole("TUTOR")
                            .requestMatchers("/tutor/user/controller/change/emailAddress").hasRole("TUTOR")
                            .requestMatchers("/tutor/user/controller/add/biography").hasRole("TUTOR")
                            .requestMatchers("/tutor/user/controller/add/specializations").hasRole("TUTOR")
                            .requestMatchers("/tutor/user/controller/remove/specializations").hasRole("TUTOR")
                            .requestMatchers("/tutor/user/controller/add/review").hasRole("STUDENT")
                            .requestMatchers("/tutor/user/controller/remove/review").hasAuthority("ADMINISTRATOR_USER")
                            .requestMatchers("/student/user/controller/change/emailAddress").hasRole("STUDENT")
                            .requestMatchers("/student/user/controller/change/password").hasRole("STUDENT")
