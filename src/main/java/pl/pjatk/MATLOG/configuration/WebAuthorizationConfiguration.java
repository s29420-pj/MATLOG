        ...
        http
                ...
                .authorizeHttpRequests(
                    auth -> auth
                            ...
                            .requestMatchers("/tutor/user/controller/change/emailAddress/**").hasAuthority("TUTOR_USER")
                            ...
                            .requestMatchers("/student/user/controller/change/emailAddress/**").hasAuthority("STUDENT_USER")
